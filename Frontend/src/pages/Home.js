...
import { Box, Container, Stack, Card, Typography, useTheme, Pagination, MenuItem, ListItemIcon, MenuList } from '@mui/material'
        ...
        <Container>
          ...
          >
            ...
            <Box sx={{ flex: 5, p: 2 }}>
              ...
              <Stack spacing={2}>
                <Pagination page={page} count={pages === 0 ? 1 : pages} on onChange={(event, value) => setPage(value)} />
              </Stack>
            </Box>
          </Stack>
        </Container>
