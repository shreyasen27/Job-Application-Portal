...
export const ALL_JOB_LOAD_REQUEST = "ALL_JOB_LOAD_REQUEST";
export const ALL_JOB_LOAD_SUCCESS = "ALL_JOB_LOAD_SUCCESS";
export const ALL_JOB_LOAD_FAIL = "ALL_JOB_LOAD_FAIL";
export const ALL_JOB_LOAD_RESET = "ALL_JOB_LOAD_RESET";
